...
/**
 * BusinessRuleOptions - The options that will be used to evaluate the rule.
 * 
 * @package TheLogicStudio\ExactPayments\Models\Shared
 * @access public
 */
class BusinessRuleOptions
{
    /**
     * The field that will be used to evaluate the rule
     * 
     * @var \TheLogicStudio\ExactPayments\Models\Shared\BusinessRuleOptionsField $field
     */
	#[\JMS\Serializer\Annotation\SerializedName('field')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\BusinessRuleOptionsField>')]
    public BusinessRuleOptionsField $field;
     ...
     * 
     * 
     * @var \TheLogicStudio\ExactPayments\Models\Shared\BusinessRuleOptionsOperator $operator
     */
	#[\JMS\Serializer\Annotation\SerializedName('operator')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\BusinessRuleOptionsOperator>')]
    public BusinessRuleOptionsOperator $operator;
	...
	{
		$this->field = \TheLogicStudio\ExactPayments\Models\Shared\BusinessRuleOptionsField::MerchantAddressCountry;
		$this->operator = \TheLogicStudio\ExactPayments\Models\Shared\BusinessRuleOptionsOperator::StartsWith;
		$this->value1 = null;
		$this->value2 = null;
	}
}

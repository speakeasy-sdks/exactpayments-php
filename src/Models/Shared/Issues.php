...
class Issues
{
     ...
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\AppleError400Code $code
     */
	#[\JMS\Serializer\Annotation\SerializedName('code')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\AppleError400Code>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AppleError400Code $code = null;
    
    /**
     * Expected field type. It is only retrieved when `code = invalid_type`.
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\AppleError400Expected $expected
     */
	#[\JMS\Serializer\Annotation\SerializedName('expected')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\AppleError400Expected>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AppleError400Expected $expected = null;
     ...
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\AppleError400Received $received
     */
	#[\JMS\Serializer\Annotation\SerializedName('received')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\AppleError400Received>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AppleError400Received $received = null;
    
    /**
     * The type of the data failing validation. It is only retrieved when `code = too_small` or `code = too_big`.
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\AppleError400Type $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\AppleError400Type>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?AppleError400Type $type = null;

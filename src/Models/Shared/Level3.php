...
/**
 * Level3 - Level 3 processing can capture and transmit the additional transaction data.
 * 
...
class Level3
{
    ...
    /**
     * alt Tax identifier of the customer.
     * 
     * @var ?string $altTaxId
     */
     ...
     * $lineItems
     * 
     * @var ?array<\TheLogicStudio\ExactPayments\Models\Shared\LineItem> $lineItems
     */
	#[\JMS\Serializer\Annotation\SerializedName('lineItems')]
    #[\JMS\Serializer\Annotation\Type('array<TheLogicStudio\ExactPayments\Models\Shared\LineItem>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    ...
    #[\JMS\Serializer\Annotation\Type('TheLogicStudio\ExactPayments\Models\Shared\ShipTo')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]

...
class NewPaymentLevel3
{
    /**
     * Tax amount of the Payment.
     * 
     * @var ?float $altTaxAmount
     */
	#[\JMS\Serializer\Annotation\SerializedName('altTaxAmount')]
    #[\JMS\Serializer\Annotation\Type('float')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?float $altTaxAmount = null;
    
    /**
     * Tax identification number of the merchant/customer.
     * 
     * @var ?string $altTaxId
     */

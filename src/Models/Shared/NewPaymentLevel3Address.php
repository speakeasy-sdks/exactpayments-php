...
/**
 * NewPaymentLevel3Address - The customer's billing address. Will be used for AVS checks so postal/zip code is the minimum data required.
 * 
 * @package TheLogicStudio\ExactPayments\Models\Shared
 * @access public
 */
class NewPaymentLevel3Address
{
    /**

...
class NewPaymentOptions
{
     ...
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\NewPaymentOptionsEcommerceFlag $ecommerceFlag
     */
	#[\JMS\Serializer\Annotation\SerializedName('ecommerceFlag')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\NewPaymentOptionsEcommerceFlag>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?NewPaymentOptionsEcommerceFlag $ecommerceFlag = null;

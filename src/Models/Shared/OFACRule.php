...
class OFACRule
{
     ...
     * 
     * @var \TheLogicStudio\ExactPayments\Models\Shared\OFACRuleOptions $options
     */
	#[\JMS\Serializer\Annotation\SerializedName('options')]
    #[\JMS\Serializer\Annotation\Type('TheLogicStudio\ExactPayments\Models\Shared\OFACRuleOptions')]
    public OFACRuleOptions $options;
    
    /**
     * Type of rule that will be evaluated by the decision engine.
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\OFACRuleType $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\OFACRuleType>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?OFACRuleType $type = null;
	...
	public function __construct()
	{
		...
		$this->onFail = "";
		$this->onPass = "";
		$this->options = new \TheLogicStudio\ExactPayments\Models\Shared\OFACRuleOptions();
		$this->type = null;
	}
}

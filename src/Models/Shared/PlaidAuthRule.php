...
/**
 * PlaidAuthRule - This authentication verification allows Exat Payments to authenticate a user's depository account information through the Plaid OAuth authorization service, making it easy to initiate credits or debits to the correct business account.
 * 
...
class PlaidAuthRule
{
     ...
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\PlaidAuthRuleType $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\PlaidAuthRuleType>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PlaidAuthRuleType $type = null;

...
/**
 * PlaidIdentityRule - This verification service allows Exact Payments to authenticate the account holder's identity of the associated depository or checking account through Plaid, thus reducing fraud and account errors.
 * 
 * @package TheLogicStudio\ExactPayments\Models\Shared
 * @access public
 */
class PlaidIdentityRule
{
    /**
     ...
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\PlaidIdentityRuleType $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\PlaidIdentityRuleType>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?PlaidIdentityRuleType $type = null;

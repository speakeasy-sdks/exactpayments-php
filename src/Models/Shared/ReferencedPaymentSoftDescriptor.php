...
/**
 * ReferencedPaymentSoftDescriptor - Override business information which would normally appear on a customer's statement, making it easier for customers to identify transactions.
 * 
 * @package TheLogicStudio\ExactPayments\Models\Shared
 * @access public
 */
class ReferencedPaymentSoftDescriptor
{
    /**
    ...
    /**
     * email of the customer/merchant.
     * 
     * @var ?string $email
     */
    ...
    /**
     * Phone number of the customer/merchant.
     * 
     * @var ?string $phone
     */
    ...
    /**
     * Identification number of the sub-merchant.
     * 

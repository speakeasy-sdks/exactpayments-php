...
/**
 * ShipTo - Optional billing details for the customer. If you have enabled AVS filters on your terminal, this becomes mandatory and AVS checks will be performed on the address.
 * 
...
class ShipTo
{
     ...
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\ShipToPhoneType $phoneType
     */
	#[\JMS\Serializer\Annotation\SerializedName('phoneType')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\ShipToPhoneType>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?ShipToPhoneType $phoneType = null;

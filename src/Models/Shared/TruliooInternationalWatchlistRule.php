...
/**
 * TruliooInternationalWatchlistRule - Watchlist screening offers comprehensive coverage of Global Anti Money Laundering (AML) risk data sources including sanction lists, law enforcement lists and regulatory bodies.
 * 
 * @package TheLogicStudio\ExactPayments\Models\Shared
 * @access public
 */
class TruliooInternationalWatchlistRule
{
    /**
     ...
     * 
     * @var ?\TheLogicStudio\ExactPayments\Models\Shared\TruliooInternationalWatchlistRuleType $type
     */
	#[\JMS\Serializer\Annotation\SerializedName('type')]
    #[\JMS\Serializer\Annotation\Type('enum<TheLogicStudio\ExactPayments\Models\Shared\TruliooInternationalWatchlistRuleType>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
    public ?TruliooInternationalWatchlistRuleType $type = null;
